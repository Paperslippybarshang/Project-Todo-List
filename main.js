...
// Write a function that will add the list elements to the array
...
// Write a function that accepts input text and creates <li> element in HTML file.
const createListElement = (item) => {
  ...
  // create div element to store buttons
  const btnGroup = document.createElement('div');
  btnGroup.setAttribute('class', 'list_buttons');
  li.append(btnGroup);
  ...
  // insert svg image inside the button 
  deleteBtn.innerHTML = deleteButton;

  // create a divider
  const divider = document.createElement('div');
  divider.setAttribute('class', 'divider');
  btnGroup.append(divider);
  ...
  // insert svg image inside the button
  completeBtn.innerHTML = completeButton;
